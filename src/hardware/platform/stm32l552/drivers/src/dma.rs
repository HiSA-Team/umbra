...
impl Dma {
    ...
    // Release a channel to the Non-Secure world.
    // This sets SECM=0, disables the channel, and reserves it in the driver.
    pub fn release_channel(&mut self, dma_id: u32, channel_id: u32) {
